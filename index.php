...
<section class="hero">
  <div class="hero-overlay">
    <h1>Discover your true potential with
      <span>Great Achievers </span> Football Academy
    </h1>
    <p>Nurturing Talent, Shaping Champions</p>
  </div>
</section>
<section id="sec-2" class="py-5 bg-custom-light">
  <div class="container my-4">
    <div class="row gx-lg-5">
      ...
      <div class="col-lg-6">
        <h3>About Great Achievers Football Club </h3>
        <p class="fw-light lh-lg my-4">Great Achievers Football Academy, a renowned football institution based in Nigeria with a vision to shape young talents into future stars. Our academy is built on a foundation of excellence, dedication, and a commitment to fostering the next generation of football achievers.
          At Great Achievers, we strive to provide a nurturing environment where aspiring young players can develop their skills, knowledge, and character. While we may not have played international matches yet, our focus on quality training and rigorous competitions has propelled our junior teams to face senior professional teams within our state and across the country, challenging them to showcase their talent and determination.</p>
...
<section class=" py-5 py-xl-8 bg-custom-color">
  ...
  <div class="container overflow-hidden">
    <div class="row gy-4 gy-md-6 gy-xl-10 gy-xxl-12">
        ...
        <div class="overflow-hidden">
          <div class="row gy-4 gy-lg-0 justify-content-center">
            <div class="col-10 col-lg-2">
              <img src="./assets/file-icons_easybuild.png" alt="" width="50" height="50">
            ...
            <div class="col-10 col-lg-9">
              <h4 class="mb-3 text-warning">Skill Building</h4>
              <p class="mb-3 text-secondary">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl,
      ...
      <div class="col-12 col-md-6 col-xl-4 border-start-md">
        <div class="overflow-hidden border-top pt-4 border-top-md-0 pt-md-0">
          <div class="row gy-4 gy-lg-0 justify-content-center">
            <div class="col-10 col-lg-2">
      ...
      <div class="col-12 col-md-6 col-xl-4 border-start-xl">
        <div class="overflow-hidden border-top pt-4 border-top-md-0 pt-md-0">
          <div class="row gy-4 gy-lg-0 justify-content-center">
            <div class="col-10 col-lg-2">
      ...
      <div class="col-12 col-md-6 col-xl-4 border-start-md border-start-xl-0">
        <div class="overflow-hidden border-top pt-4 border-top-md-0 pt-md-0">
          <div class="row gy-4 gy-lg-0 justify-content-center">
            <div class="col-10 col-lg-2">
            ...
            <div class="col-10 col-lg-9">
              ...
              <p class="mb-3 text-secondary">Our academy empowers you to unleash your potential, fostering discipline,
                resilience, and valuable life skills</p>
              <div>
                <a href="#!" class="fw-bold text-decoration-none link-primary">
                  Learn More
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
...
<section class="container">
  ...
  <a href="./pages/gallery.html" class="btn btn-primary btn-lg disabled" tabindex="-1" role="button" aria-disabled="false">Primary link</a>
  ...
  <div class="container my-4">
    <div class="row gx-lg-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="text-white fw-light lh-lg my-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit
        ...
        <button class="btn btn-warningF">Read More</button>
      </div>
    </div>
  </div>
</section>

<section class="contact-section bg-custom-light ">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="contact-info text-white">
          <h1>Any Questions?
            Connect with us today!</h1>
